...
public class Prueba {
    public static void main(String[] args) {
        ...
        ListaGenerica<String> pasandoPor = new ListaEnlazadaGenerica<>();
        //pasandoPor.agregarFinal("Buenos Aires");
        pasandoPor.agregarFinal("Pinamar");
        Parcial p = new Parcial();
        ListaGenerica<String> camino = p.resolver(grafo, "La plata", "Gesell", pasandoPor);
        camino.comenzar();
        while (!camino.fin()){
